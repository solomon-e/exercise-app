    ...
    <>
      {user && (
        <>
          ...
          <Link to='/exercises' className='text-xs md:text-sm font-semibold uppercase p-1 my-1 md:mr-4 hover:border-b-2 border-black'>
            Exercises
          </Link>
          <Link to='/workouts' className='text-xs md:text-sm font-semibold uppercase p-1 my-1 md:mr-4 hover:border-b-2 border-black'>
            Workouts Log
          </Link>
    ...
    <>
      <header className='bg-white'>
        <div className='text-xl md:text-3xl font-semibold bg-white px-5 py-6 md:px-14 md:py-10 flex items-center justify-between'>
          ...
          <CgGym className='text-xl md:text-4xl'/><h1> Gym Buddy</h1>
          </Link>
          <div className='md:hidden'>
            <button onClick={toggleNavbar}>
              {isOpen ? <LiaTimesSolid className='text-2xl'/> : <RxHamburgerMenu className='text-2xl'/>}
            </button>
          </div>
